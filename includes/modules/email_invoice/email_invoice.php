...
if (SEND_EMAILS == 'true') {
	...
	if (EMAIL_USE_HTML == 'true') {
		$ei_admin = DIR_FS_CATALOG . "admin/";
		$ei_image_dir = DIR_WS_IMAGES;
		...
		$ei_css_path = $ei_template_dir;

		require(DIR_FS_CATALOG . "admin/" . DIR_WS_LANGUAGES . $language . "/" . FILENAME_ORDERS_INVOICE);
