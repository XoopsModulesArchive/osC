      ...
      <tr bgcolor="#000000">
        <td><table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
          <tr bgcolor="#ffffff" height="50">
            <td height="50"><?php echo tep_image(DIR_WS_IMAGES . 'ferastore_logo.png', 'xosC', '92', '52'); ?></td>
...
<?php
  ...
  $contents[] = array('params' => 'class="infoBox"',
                      'text'  => '<a href="http://www.feratechinc.com" target="_blank">' . BOX_ENTRY_SUPPORT_SITE . '</a><br>' .
                                 '<a href="http://www.feratechinc.com/modules/newbb/" target="_blank">' . BOX_ENTRY_SUPPORT_FORUMS . '</a>' );
