...
//  $xTheme->addCSS("/templates/stylesheet.css");
?>
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">Distributors</td>
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent">Distributor Names</td>
                <td class="dataTableHeadingContent">Distributor Descriptions</td>
              </tr>
<?php
    $search = '';
