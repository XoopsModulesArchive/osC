...
/* ###################### Element supprimé afin d'éviter la double insertion de statut
			if($CommentsWithStatus) {
...
// Mise à jour champs commentaires - Résoudre le bug lors pour envoi de mail quand le statut est toujours identique
