<?php
	...
	include_once('configure.php'); // Copy of admin/includes/configure.php placed in the same dir as config.inc. chdir did not work. Have to find better
...
/*		array (																		
	...
	$cfg['ilibs_dir'] 	   = array(DIR_WS_IMAGES);						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
