...
// Rigadin: removed reference to popup button as not used anymore.
          ...
          <div id="mainDiv">
            ...
            <div id="inDiv" class="hideit">
              ...
              <div id="poDiv" class="hideit">
                ...
                <div class="rowDiv">
                  ...
                  <input class="fldmlg" id="popTitle" name="popTitle" type="text" value="" disabled="true" readonly="true"/>
                </div>
              </div>
              <!- // poDiv -->
              <!- file section ----------------------------------------------------- -->
            ...
            <div id="atDiv" class="hideit">
              ...
              <div class="rowDiv">
                ...
                <input class="fldmlg" id="pr_title" name="pr_title" type="text" value="" onChange="updateStyle()" disabled="true" readonly="true"/>
              </div>
              <div class="rowDiv">
                <div class="btnRight">
                ...
                <input class="fldmlg" id="pr_alt" name="pr_alt" type="text" value="" onChange="updateStyle()" disabled="true" readonly="true" />
              </div>
              </fieldset>
              <div class="floatWrap">
                <!- left column ------------------------------------------------------ -->
                <div class="colLeft">
                  ...
                  <div class="rowDiv">
					...
					<!-- Rigadin: disable selection //-->
                    <select disabled="true" class="fldm" id="pr_class" name="pr_class" onChange="updateStyle()">
                      <option value="default" selected="selected"><?php echo $l->m('at_099'); ?></option>
                      <?php echo getStyles(false); ?>
                    </select>
                  </div>
                  ...
                  <div class="rowDiv">
					...
					<!-- Rigadin: disable selection //-->
                    <select disabled="true" class="fldm" id="pr_align" name="pr_align" onChange="updateStyle()" >
                  ...
                  <div class="rowDiv">
					...
					<!-- Rigadin: disable selection //-->
                    <input disabled="true" class="fldsm" id="pr_border" name="pr_border" type="text"value="" maxlength="2" onChange="updateStyle();" onKeyUp="RemoveInvalidChars(this, '[^0-9]');"  />
                    <span class="frmText"> (px) </span>
                  </div>
                  <div class="rowDiv">
                    <label for="pr_vspace"> <span class="pad10"> <?php echo $l->m('at_026'); ?> </span> </label>
										<!-- Rigadin: disable selection //-->
                    <input disabled="true"  class="fldsm" id="pr_vspace" name="pr_vspace" type="text" value="" maxlength="2" onChange="updateStyle();" onKeyUp="RemoveInvalidChars(this, '[^0-9]');" />
                    <span class="frmText"> (px) </span>
                  </div>
                  <div class="rowDiv">
                    <label for="pr_hspace"> <span class="pad10"> <?php echo $l->m('at_027'); ?> </span> </label>
					<!-- Rigadin: disable selection //-->
                    <input disabled="true"  class="fldsm" id="pr_hspace" name="pr_hspace" type="text" value="" maxlength="2" onChange="updateStyle();" onKeyUp="RemoveInvalidChars(this, '[^0-9]');" />
                    <span class="frmText"> (px) </span>
                  </div>
                </div>
                <!- // colLeft -->
                ...
                <div class="rowDiv">
				  ...
				  <!-- Rigadin: disable selection //-->
                  <input name="pr_chkCaption" type="checkbox" class="chkBox" id="pr_chkCaption" onChange="updateStyle()" value="1" disabled="true" />
                ...
                <div class="rowDiv">
				  ...
				  <!-- Rigadin: disable selection //-->
                  <select class="fldm" id="pr_captionClass" name="pr_captionClass" onChange="updateStyle()" disabled="true">
                    <option value="default" selected="selected"><?php echo $l->m('at_099'); ?></option>
