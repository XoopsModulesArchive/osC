...
// ================================================
	...
	function TinyMCE_ibrowser2_getControlHTML(control_name) {
		switch (control_name) {
			case 'ibrowser2':
				return '<img id="{$editor_id}_ibrowser2" src="{$pluginurl}/images/ibrowser.gif" title="iBrowser2" width="20" height="20" class="mceButtonNormal" onmouseover="tinyMCE.switchClass(this,\'mceButtonOver\');" onmouseout="tinyMCE.restoreClass(this);" onmousedown="tinyMCE.restoreAndSwitchClass(this,\'mceButtonDown\');" onclick="(iBrowser2_click(\'{$editor_id}\'));">';
			}	
		return '';
	}
	//-------------------------------------------------------------------------
