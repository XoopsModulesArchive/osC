...
// NOTE: Includes a workaround for dates before 01/01/1970 that fail on windows servers
  ...
  function tep_address_format($address_format_id, $address, $html, $boln, $eoln, $ajax, $order_id) {
    ...
    $company = (($address['company'] != '') ? (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'company\', \'' . tep_output_string_protected($address['company']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['company']) . (($ajax != '') ? '</a>' : '') : '');
    if (isset($address['firstname']) && tep_not_null($address['firstname'])) {
      $firstname = tep_output_string_protected($address['firstname']);
      $lastname = tep_output_string_protected($address['lastname']);
    } elseif (isset($address['name']) && tep_not_null($address['name'])) {
      $firstname = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'name\', \'' . tep_output_string_protected($address['name']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['name']) . (($ajax != '') ? '</a>' : '');
      $lastname = '';
    } else {
      $firstname = '';
      $lastname = '';
    }
    $street = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'street_address\', \'' . tep_output_string_protected($address['street_address']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['street_address']) . (($ajax != '') ? '</a>' : '');
    (($address['suburb'] != '') ? $suburb = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'suburb\', \'' . tep_output_string_protected($address['suburb']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['suburb']) . (($ajax != '') ? '</a>' : '') : '');
    $city = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'city\', \'' . tep_output_string_protected($address['city']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['city']) . (($ajax != '') ? '</a>' : '');
    $state = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'state\', \'' . tep_output_string_protected($address['state']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['state']) . (($ajax != '') ? '</a>' : '');
    if (isset($address['country_id']) && tep_not_null($address['country_id'])) {
      ...
      $country = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'country\', \'' . tep_output_string_protected($address['country']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['country']) . (($ajax != '') ? '</a>' : '');
    } else {
      $country = '';
    }
    $postcode = (($ajax != '') ? '<a href="javascript: updateOrderField(\'' . $order_id . '\', \'orders\', \'' . $ajax . 'postcode\', \'' . tep_output_string_protected($address['postcode']) . '\');" class="ajaxLink">' : '') . tep_output_string_protected($address['postcode']) . (($ajax != '') ? '</a>' : '');
    $zip = $postcode;
