...
<?php
  ...
  if ($selected_box == 'catalog') {
    $contents[] = array('text'  => '<a href="' . tep_href_link(FILENAME_CATEGORIES, 'selected_box=catalog', 'NONSSL') . '" class="menuBoxContentLink">' . BOX_CATALOG_CATEGORIES_PRODUCTS . '</a><br>' .
                                   ...
                                   '<a href="' . tep_href_link(FILENAME_DEFINE_MAINPAGE, 'selected_box=catalog', 'NONSSL') . '" class="menuBoxContentLink">' . BOX_CATALOG_DEFINE_MAINPAGE . '</a><br>' .
				   '<a href="' . tep_href_link(FILENAME_DEFINE_MAINLOGO, 'selected_box=catalog', 'NONSSL') . '" class="menuBoxContentLink">' . BOX_CATALOG_DEFINE_MAINLOGO . '</a><br>' .
