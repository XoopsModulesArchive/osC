...
define('ENTRY_SUBURB', 'Street Address 2:');
...
define('BOX_CATALOG_DEFINE_MAINPAGE', 'Edit Front Page');

// define_mainlogo to edit store logo
define('BOX_CATALOG_DEFINE_MAINLOGO', 'Edit Main Logo');
